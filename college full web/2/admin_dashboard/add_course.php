                ...
                <div class="col-4">
                  ...
                  <div class="card mb-4">
                    ...
                    <?php
                        ...
                        ?>
                     <form action="add_course.php" method="post" class="new-added-form" enctype="multipart/form-data">
                        <div class="row">
                           <input type="hidden" name="userid" value="<?php echo $userid ?>">
                           <div class="col-6 col-12 form-group">
                              <input type="text" placeholder="Course Number" class="form-control" required name="course_code" style="background-color:#FBE47B;">
                           </div><br><br><br>
                           <div class="col-6 col-12 form-group">
                              <input type="text" placeholder="Course Name" class="form-control" required  name="course_name" style="background-color:#FBE47B;">
                           </div><br><br>
                           <div class="col-lg-12 col-12 form-group mg-t-30">
                              <label class="text-dark-medium">Upload Course Details</label>
                        ...
                        if(isset($_POST['submit'])){
                            ...
                            if(in_array($file_extension, $allowed_extensions)){
                                ...
                                if(move_uploaded_file($file_tmp, $target)){
                                    // Update the database
                                    $query = mysqli_query($con, "INSERT INTO `courses` (`userid`, `course_code`, `course_name`, `course_details`) VALUES ('$userid', '$course_code', '$course_name', '$file')");
                                    
                                    if($query){
                                        echo '<script>alert("Inserted Successfully");window.location.assign("add_course.php");</script>';
                                    } else{
                                        $error_message = mysqli_error($con);
                                        echo '<script>alert("Inserted Unsuccessfully: ' . $error_message . '");window.location.assign("add_course.php");</script>'; 
                                    }
                                } else {
                                    echo '<script>alert("Error uploading file.");window.location.assign("add_course.php");</script>';
                                }
                            } else {
                                echo '<script>alert("Invalid file type. Please upload a PDF or DOCX file.");window.location.assign("add_course.php");</script>';
                            }
                        }
                        ?>
                    </div>
