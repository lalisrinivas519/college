                        ...
                        <table class="table display data-table text-nowrap">
                           <thead>
                              <tr style="background-color:#fd7e14; text-color:black;">
                                 <th style="border: 1px solid black;"><font color="black">Sl No</font></th>
                                 <th style="border: 1px solid black;"><font color="">Staff Id</font></th>
                                 <th style="border: 1px solid black;"><font color="black">Name</font></th>
                                 <th style="border: 1px solid black;"><font color="black">Chat Date</font></th>
                                 <th style="border: 1px solid black;"><font color="black">Subject</font></th>
                                 <th style="border: 1px solid black;"><font color="black">Message</font></th>
                              </tr>
                           </thead>
                           <?php
