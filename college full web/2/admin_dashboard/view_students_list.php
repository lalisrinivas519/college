               ...
               <table class="table display data-table text-nowrap">
                  <thead>
                     <tr style="background-color:#fd7e14; text-color:black;">
                        ...
                        <th style="border: 1px solid black;"><font color="black">Father Name </font></th>
                        <th style="border: 1px solid black;"><font color="black">Mother Name </font></th>
                        ...
                        <th style="border: 1px solid black;"><font color="black">DOB </font></th>
						...
						<th style="border: 1px solid black;"><font color="black">Which Branch </font></th>
                        <th style="border: 1px solid black;"><font color="black">Admission No</font></th>
                        <th style="border: 1px solid black;"><font color="black">Date of Admission</font></th>
						<th style="border: 1px solid black;"><font color="black">Password</font></th>
                     </tr>
                  </thead>
                  <tbody>
                     <?php
                        ...
                        while ($row = mysqli_fetch_array($query)) {
                            ...
                            echo "<tr>
                                ...
                                <td style='border:1px solid black;'>$blood_group</td>
                                ...
                                <td style='border:1px solid black;'>$which_branch</td>  
                                <td style='border:1px solid black;'>$admission_no</td>   
                                <td style='border:1px solid black;'>$date_of_admission</td>    
