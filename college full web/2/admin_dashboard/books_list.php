                ...
                <div class="col-12">
                  ...
                  <div class="card mb-4">
                    <div class="card-header">
                     ...
                     <br>
                     <br>
                    <div class="table-res <div class="table-responsive">
                     <table class="table display data-table text-nowrap">
                        <thead>
                           <tr style="background-color:#fd7e14; text-color:black;">
                              <th style="border: 1px solid ;"><font color="black"> Sl No</font></th>
                              <th style="border: 1px solid ;"><font color="black"> Admin ID</font></th>
                              <th style="border: 1px solid black;"><font color="black">Book Number </font></th>
                              <th style="border: 1px solid black;"><font color="black"> Book Name</font></th>
                              <th style="border: 1px solid black;"><font color="black"> Author Name</font></th>
