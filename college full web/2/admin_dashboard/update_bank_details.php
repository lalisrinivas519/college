            ...
            <div class="container-fluid">
              ...
              <div class="row">
                <div class="col-12 col-xl-12">
                  ...
                  <!-- Breadcrumb end -->
                  <h2 class="mb-2">Update Bank Details</h2>
                     ...
                     <form action="update_bank_details.php" method="post" class="new-added-form" enctype="multipart/form-data">
                        <div class="row">
                           ...
                           <div class="col-6 col-12 form-group">
                              <input type="text" placeholder="Account Number" class="form-control" required name="acc_no" style="background-color:#FBE47B;">
                           </div><br><br>
                           <div class="col-6 col-12 form-group">
                              <input type="text" placeholder="Account Holder Name" class="form-control" required name="account_holder_name" style="background-color:#FBE47B;">
                           </div><br><br>
                           <div class="col-6 col-12 form-group">
                              <input type="text" placeholder="Bank Name" class="form-control" name="bank_name" required style="background-color:#FBE47B;">
                           </div><br><br>
                           <div class="col-6 col-12 form-group">
                              <input type="text" placeholder="IFSC Code" class="form-control" name="ifsc_code" required  style="background-color:#FBE47B;">
                           </div><br><br>
                           <div class="col-6 col-12 form-group">
                              <input type="text" placeholder="Branch Name" class="form-control" name="branch" required style="background-color:#FBE47B;">
                           </div>
						   <br><br>
