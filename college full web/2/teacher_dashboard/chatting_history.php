...
<div id="removeNotificationModal" class="modal fade zoomIn" tabindex="-1" aria-hidden="true">
 ...
 <div class="col-lg-6">
                                    <div class="p-lg-5 p-4">
                                        <div>
                                            <h5 class="text-primary">Chatting History</h5>
                                        </div>
                        ...
                        <table class="table display data-table text-nowrap">
                           <thead>
                              <tr style="background-color:#fd7e14; text-color:white;">
                                 ...
                                 <th style="border: 1px solid black;"><font color="white">Admin Id</font></th>
                           ...
                           <tbody>
                              <?php
                                 ...
                                 $query = mysqli_query($con, "SELECT * FROM `admin_chat`");
