                    ...
                    <li>
                      ...
                      <form action="edit_profile.php" method="post" class="new-added-form">
                        <div class="row">
                           ...
                           <div class="col-sm-6 form-group">
                              <label>Mobile </label>
                              <input type="number" placeholder="Email" required class="form-control" name="mobile" style="background-color:#FBE47B;">
                           </div>
                           <div class="col-sm-6 form-group">
                              <label>Address</label>
                           ...
                           <div class="col-sm-6 form-group">
                              <label>Country</label>
                              <select id="country" name="country" required class="form-control" style="background-color:#FBE47B;">
                           ...
                           <div class="col-sm-6 form-group">
                              ...
                              <input class="form-control" id="inputDistrict" required placeholder="District" name="district" type="district" style="background-color:#FBE47B;">
                                 
                           </div>
                           <div class="col-sm-6 form-group">
                              <label>Pincode</label>
                              <input type="number" placeholder="Pincode" required class="form-control" name="pincode" style="background-color:#FBE47B;">
                           </div>
                           <br><br><br><br><br>
