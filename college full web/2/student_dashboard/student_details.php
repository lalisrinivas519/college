                ...
                <div class="panel mb-25">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                           ...
                           <div class="col-sm-6 form-group">
                              <label>Email</label>
                              <input type="email" placeholder="Email" class="form-control" required name="email" style="background-color:#FBE47B;">
                           </div><br>
                           <div class="col-sm-6 form-group">
                              <label>Mobile </label>
                              <input type="number" placeholder="Mobile" class="form-control" required name="mobile" style="background-color:#FBE47B;">
                           </div><br>
                           <div class="col-sm-6 form-group">
                              <label>Address</label>
                           ...
                           <div class="col-sm-6 form-group">
                              ...
                              <input class="form-control" required id="inputDistrict" type="text" name="district" placeholder="District" style="background-color:#FBE47B;">
                                 
                           </div>
                           <div class="col-sm-6 form-group">
                              <label>Pincode</label>
                              <input type="text" placeholder="Pincode" required class="form-control" name="pincode" style="background-color:#FBE47B;">
                           </div><br><br>
                           <center>
                           <div class="col-sm-6 form-group">
