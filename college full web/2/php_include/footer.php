          ...
          <div class="row">
            <div class="col-lg-3 col-sm-3">
              <section class="footer-section">
                <h3 class="about.php">ABOUT US</h3>
                <a href="home.php"><img class="footer-logo img-responsive" src="assets/img/logo_white.png" height="50" width="195" alt="Logo"></a>
                ...
                <div class="footer-contacts footer-contacts_mod-a"> <i class="icon stroke icon-Pointer"></i>
                  ...
                  Yelahanka New Town, Yelahanka, Bengaluru, Karnataka India
                  </address>
                </div>
                <div class="footer-contacts"> <i class="icon stroke icon-Phone2"></i> <span class="footer-contacts__inner">Call us +91 9513228259</span> </div>
                <div class="footer-contacts"> <i class="icon stroke icon-Mail"></i> <a class="footer-contacts__inner" href="mailto:info@vivatech.me">info@vivatech.me</a> </div>
              </section>
              <!-- end footer-section --> 
            </div>
            <!-- end col -->
            ...
            <div class="col-lg-3 col-sm-3">
              <section class="footer-section">
                ...
                <div class="tweets">
                  ...
                  <span class="tweets__time">9 hours ago</span> </div>
                <a class="tweets__link" href="javascript:void(0);">Follow @Academic viva</a> </section>
              <!-- end footer-section --> 
            </div>
            <!-- end col -->
        ...
        <div class="row">
          <div class="col-xs-12">
            <div class="footer-bottom">
              <div class="viva">viva <a href="javascript:void(0);">Academic viva</a>, Online Learning  |  Created by <a href="javascript:void(0);">Templines</a></div>
