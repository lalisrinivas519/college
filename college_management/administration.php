...
<html lang="en">
   <head>
      <title>ABOUT ADMINISTRATION</title>
   </head>
   ...
   <body>
      ...
      <main>
         ...
         <section class="page-banner bg-image section-padding" style="background-image: url('images/banner.jpg'); background-size: cover; background-position: center;">
            ...
            <div class="container">
               <h2 class="wow fadeInUp" data-wow-duration="1.3s" data-wow-delay=".3s">ABOUT ADMINISTRATION</h2>
                     ...
                     <div class="swiper-wrapper">
                        <div class="swiper-slide">
                           <div class="item">
                              ...
                              <img src="images/administrater1.jpg" alt="image">
                              </a>
                              <div class="team-info">
                        ...
                        <div class="swiper-slide">
                           <div class="item">
                              <a class="image d-block">
                              <img src="images/administrater2.jpg" alt="image">
                              </a>
                              <div class="team-info">
                                 <a class="d-block" href="#0"><i class="fa-brands fa-facebook-f"></i></a>
                                 <a class="d-block" href="#0"><i class="fa-brands fa-twitter"></i></a>
                        ...
                        <div class="swiper-slide">
                           <div class="item">
                              <a class="image d-block">
                              <img src="images/administrater3.jpg" alt="image">
                              </a>
                              <div class="team-info">
                                 <a class="d-block" href="#0"><i class="fa-brands fa-facebook-f"></i></a>
                                 <a class="d-block" href="#0"><i class="fa-brands fa-twitter"></i></a>
