   ...
   <body>
      ...
      <main>
         ...
         <section class="page-banner bg-image section-padding" style="background-image: url('images/banner.jpg'); background-size: cover; background-position: center;">
            ...
            <div class="container">
               <h2 class="wow fadeInUp" data-wow-duration="1.3s" data-wow-delay=".3s">Our College Alumini Meet</h2>
               <div class="breadcrumb-list wow fadeInUp" data-wow-duration="1.6s" data-wow-delay=".6s">
                  <a href="index.php">Home :</a>
                  <span>Alumini Meet</span>
               </div>
            </div>
         </section>
               ...
               <div class="row g-4">
                  <div class="col-lg-4 col-md-6">
                     <div class="item">
                        ...
                        <img src="images/aluminimeet1.jpg" class="shadow" style="height:500px" alt="image">
                        </a>
                        <div class="content">
                           <h3><a href="">Alumini Meet</a></h3>
                           <span>2020</span>
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-4 col-md-6">
                     <div class="item">
                        <a href="" class="image d-block">
                        <img src="images/aluminimeet2.webp" class="shadow" alt="image">
                        </a>
                        <div class="content">
                           <h3><a href="">Alumini Meet</a></h3>
                           <span>2021</span>
                  ...
                  <div class="col-lg-4 col-md-6">
                     <div class="item">
                        <a href="" class="image d-block">
                        <img src="images/aluminimeet3.png" class="shadow" alt="image">
                        </a>
                        <div class="content">
                           <h3><a href="">Alumini Meet</a></h3>
                           <span>2022</span>
