                        ...
                        <table class="table display data-table text-nowrap">
                           <thead>
                              <tr style="background-color:#fd7e14; text-color:white;">
                                 ...
                                 <th style="border: 1px solid black;"><font color="white">Staff Name</font></th>
                                 <th style="border: 1px solid black;"><font color="white">Student Name</font></th>
                                 <th style="border: 1px solid black;"><font color="white">Lesson No</font></th>
                                 <th style="border: 1px solid black;"><font color="white">Lesson Name</font></th>
                                 <th style="border: 1px solid black;"><font color="white">Assignment</font></th>
                              </tr>
                           </thead>
                           <?php
                           ...
                           <tr>
                              ...
                              <td style='border:1px solid black;'>
                                 <a href="kyc/<?php echo $assignment; ?>"> <img src="kyc/<?php echo $assignment; ?>"></a>
                              </td>
                           </tr>
                           <?php
                              }
