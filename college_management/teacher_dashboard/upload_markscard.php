               ...
               <div class="card height-auto">
                  <div class="card-body" style="width:470px; ">
                     ...
                     <?php
                        ...
                        ?>
                     <form action="upload_markscard.php" method="post" class="new-added-form" enctype="multipart/form-data">
                        <div class="row">
                           <input type="hidden" name="userid" value="<?php echo $userid ?>">
                           <div class="col-6 col-12 form-group">
                              <input type="text" placeholder="Student ID" class="form-control" name="student_id" style="background-color:#FBE47B;">
                           </div>
                           <div class="col-6 col-12 form-group">
                              <input type="text" placeholder="Student Name" class="form-control" name="student_name" style="background-color:#FBE47B;">
                           </div>
