                  ...
                  <div class="card-body">
                     ...
                     <form action="add_students.php" method="post" class="new-added-form">
                        <div class="row">
                           <div class="col-sm-6 form-group">
                              ...
                              <input type="text" placeholder="Student ID" class="form-control" name="userid" style="background-color:#FBE47B;">
                           </div>
                           <div class="col-sm-6 form-group">
                              <label>Name </label>
                           ...
                           <div class="col-sm-6 form-group">
                              ...
                              <input type="text" placeholder="Father Name " class="form-control" name="father_name" style="background-color:#FBE47B;">
                           </div>
                           <div class="col-sm-6 form-group">
                              <label>Mother Name </label>
                              <input type="text" placeholder="Mother Name" class="form-control" name="mother_name" style="background-color:#FBE47B;">
                           </div>
                           <div class="col-sm-6 form-group">
                              <label>Email</label>
                              <input type="email" placeholder="Email" class="form-control" name="email" style="background-color:#FBE47B;">
                           </div>
                           <div class="col-sm-6 form-group">
                              <label>Mobile </label>
                           ...
                           <div class="col-sm-6 form-group">
                              ...
                              <input type="date" placeholder="" class="form-control" name="dob" style="background-color:#FBE47B;">
                           </div>
                           <div class="col-sm-6 form-group">
                              <label>Age</label>
                           ...
                           <div class="col-sm-6 form-group">
                              ...
                              <input type="text" placeholder="Which Branch" class="form-control" name="which_branch" style="background-color:#FBE47B;">
                           </div>
                           <div class="col-sm-6 form-group">
                              <label>Admission No </label>
                              <input type="text" placeholder="Admission No " class="form-control" name="admission_no" style="background-color:#FBE47B;">
                           </div>
                           <div class="col-sm-6 form-group">
                              <label>Date Of Admission </label>
                              <input type="date" placeholder="" class="form-control" name="date_of_admission" style="background-color:#FBE47B;">
                           </div>
                           <div class="col-sm-6 form-group">
                     ...
                     <?php
                        if(isset($_POST['submit'])) {
                            ...
                            $query_contact=mysqli_query($con,"INSERT INTO `user`(`userid`, `name`,`father_name`,`mother_name`, `email`, `mobile`, `gender`, `password`, `who_i_am`, `position`, `dob`, `age`, `address`, `country`, `state`, `district`, `pincode`, `bloodgroup`, `religion`, `caste`, `which_branch`, `admission_no`, `date_of_admission`) 
                        	VALUES ('$userid','$name','$father_name','$mother_name','$email','$mobile','$gender','$password','$position','$position','$dob','$age','$address','$country','$state','$district','$pincode','$bloodgroup','$religion','$caste','$which_branch','$admission_no','$date_of_admission')"); 
