                     ...
                     <form action="add_course.php" method="post" class="new-added-form" enctype="multipart/form-data">
                        <div class="row">
                           ...
                           <div class="col-6 col-12 form-group">
                              <input type="text" placeholder="Course Number" class="form-control" name="course_code" style="background-color:#FBE47B;">
                           </div>
                           <div class="col-6 col-12 form-group">
                              <input type="text" placeholder="Course Name" class="form-control" name="course_name" style="background-color:#FBE47B;">
                           </div>
