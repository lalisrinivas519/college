...
<?php
 ...
 <?php
                                       ...
                                       ?>                                                <label class="text-dark-medium">Upload Aadhar Front Image (150px X 150px)</label>
                                        ...
                                        if (isset($_POST['submit'])) {
                                            ...
                                            if (!empty($userid)) {
                                                ...
                                                if ($query) {
                                                    ...
                                                    echo '<script>alert("Something Went Wrong.");window.location.assign("update_aadhaar.php");</script>';
                                                }
                                            } else {
                                                echo '<script>alert("Please Fill All The Fields.");window.location.assign("update_aadhaar.php");</script>';
                                            }
                                        }
                                        ?>

                                        <!-- Second form for Aadhar Back Image -->
                                        <form action="update_aadhaar.php" method="post" class="new-added-form" enctype="multipart/form-data">
                                            <input type="hidden" name="userid" value="<?php echo $userid; ?>">
                                            <div class="col-lg-12 col-12 form-group mg-t-30">
                                                <?php if ($row['adhar_back'] == NULL) : ?>
                                                ...
                                                <?php endif; ?>
                                                <label class="text-dark-medium">Upload Aadhar Back Image (150px X 150px)</label>
                                                <input type="file" class="form-control" name="image" style="background-color:#FBE47B;"><br>
                                            </div>
