                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="index.php" data-bs-toggle="" role="button" aria-expanded="false" aria-controls="sidebarDashboards">
                                ...
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="#" target="_blank" class="nav-link" data-key="t-horizontal">Profile</a>
                                    </li>
									<li class="nav-item">
                                        <a href="edit_profile.php" target="_blank" class="nav-link" data-key="t-detached">Edit Profile</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="photo.php" target="_blank" class="nav-link" data-key="t-detached">Edit Photo</a>
                                    </li>
									<li class="nav-item">
                                        <a href="password.php" target="_blank" class="nav-link" data-key="t-detached">Edit Password</a>
                                    </li>
                       ...
                       <li class="nav-item">
                            <a class="nav-link menu-link" href="#sidebarLayouts" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarLayouts">
                                <i class="ri-layout-3-line"></i> <span data-key="t-layouts">Layouts</span> <span  data-key="t-hot">Hot</span>
                            </a>
						...
						<li class="nav-item">
                                        <a href="#sidebarProjects" class="nav-link" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarProjects" data-key="t-projects"><i class="ri-layout-3-line"></i>
                                            Projects
                                        </a>
                                        <div class="collapse menu-dropdown" id="sidebarProjects">
                                            <ul class="nav nav-sm flex-column">
                                                ...
                                                <li class="nav-item">
                                                    <a href="table.php" class="nav-link" data-key="t-overview"> Table</a>
                                                </li>
                                                <li class="nav-item">
