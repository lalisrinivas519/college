											...
											<div class="mb-3">
												...
												<div class="mb-3">
												 ...
												 <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="district" placeholder="Enter your district" name="district">
                                                </div>
												 <div class="mb-3">
                                                ...
                                                <div class="mt-4">
                                                    <button class="btn btn-success w-100" type="submit" name="submit" value="submit">Submit</button>
                                                </div>
